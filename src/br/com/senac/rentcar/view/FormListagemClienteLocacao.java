 ...
 * @author sala304b
 */
public class FormListagemClienteLocacao extends javax.swing.JFrame {

    private ClienteTableModel clienteTableModel;
        private Veiculo veiculo;
    
    public FormListagemClienteLocacao(Veiculo veiculo) {
        initComponents();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha <0) {
            ...
            Cliente cliente = clienteTableModel.getCliente(linha);
            //carregando o form de locação
            FormLocacao formLocacao = new FormLocacao(veiculo, cliente);
            formLocacao.setVisible(true);
            this.dispose();
        }
